      ...
      var e = {
          115: (e, t, n) => {
            ...
            class g extends r.BaseCommand {
              ...
              async execute() {
                ...
                const l = this.cli.process([this.commandName, ...this.args]),
                  p = 1 === l.path.length && 'run' === l.path[0] && void 0 !== l.scriptName ? l.scriptName : null;
                if (0 === l.path.length)
                ...
                for (const e of g)
                  (p && !e.manifest.scripts.has(p)) ||
                    (p === process.env.npm_lifecycle_event && e.cwd === o.cwd) ||
                    (this.include.length > 0 && !u().isMatch(a.structUtils.stringifyIdent(e.locator), this.include)) ||
                    (this.exclude.length > 0 && u().isMatch(a.structUtils.stringifyIdent(e.locator), this.exclude)) ||
                ...
                const S = await a.StreamReport.start({ configuration: t, stdout: this.context.stdout }, async (e) => {
                  ...
                  for (; m.size > 0 && !e.hasErrors(); ) {
                    const r = [];
                    for (const [e, t] of m) {
                      if (_.has(t.anchoredDescriptor.descriptorHash)) continue;
                      let a = !0;
                      if (this.topological || this.topologicalDev) {
                        ...
                        for (const t of e.values()) {
                          ...
                          if (((a = null === e || !m.has(e.anchoredLocator.locatorHash)), !a)) break;
                        }
                      }
                      if (
                        a &&
                        ...
                        r.push(
                          C(async () => {
                            ...
                            return m.delete(e), _.delete(t.anchoredDescriptor.descriptorHash), n;
                          })
                        ),
                        !this.parallel)
                      )
            ...
            (g.schema = i
              ...
              o([s.Command.Boolean('-a', { hidden: !0 })], g.prototype, 'allLegacy', void 0),
              o(
              ...
              o(
                [
                  s.Command.Array('--include', {
                    description: 'An array of glob pattern idents that acts as a whitelist of workspaces'
                  })
                ],
                g.prototype,
                'include',
              ...
              o(
                [
                  s.Command.Array('--exclude', {
                    description: 'An array of glob pattern idents that acts as a blacklist of workspaces'
                  })
                ],
                g.prototype,
                'exclude',
              ...
              o(
                [s.Command.Boolean('--private', { description: 'Also run the command on private workspaces' })],
                g.prototype,
                'private',
                void 0
              ),
            ...
            e.exports = (e, t = {}) => {
              let n = void 0 === t.rangeLimit ? 1e3 : t.rangeLimit,
                i = (e, l = {}) => {
                  ...
                  let p = l,
                    u = l.queue;
                  for (; 'brace' !== p.type && 'root' !== p.type && p.parent; ) (p = p.parent), (u = p.queue);
                  if (e.invalid || e.dollar) return void u.push(s(u.pop(), r(e, t)));
                  ...
                  if (e.nodes && e.ranges > 0) {
                    ...
                    let l = o(...i, t);
                    return 0 === l.length && (l = r(e, t)), u.push(s(u.pop(), l)), void (e.nodes = []);
                  }
            ...
            const o = n(669),
              ...
              l = (e, t, n) => {
                ...
                for (let s = 0; s < t.length; s++) {
                  ...
                  for (let t of e) {
                    let e = p(t, !0);
                    (u ? !e.isMatch : e.isMatch) && (u ? o.add(e.output) : (o.delete(e.output), r.add(e.output)));
                  }
                }
                let p = (i === t.length ? [...s] : [...r]).filter((e) => !o.has(e));
                if (n && 0 === p.length) {
          ...
          974: (e, t, n) => {
            ...
            (d.fastpaths = (e, t) => {
              ...
              let C = !0 === n.bash ? '.*?' : y;
              n.capture && (C = `(${C})`);
              const b = (e) => (!0 === e.noglobstar ? C : `(${E}(?:(?!${R}${e.dot ? f : u}).)*?)`),
                x = (e) => {
                  switch (e) {
                    case '*':
                      return `${m}${d}${C}`;
          ...
          828: (e, t, n) => {
            const o = n(622),
              ...
              l = (e, t, n = !1) => {
                ...
                const d = (n, o = !1) => {
                  const { isMatch: r, match: s, output: d } = l.test(n, p, t, { glob: e, posix: i }),
                    f = { glob: e, state: u, regex: p, posix: i, input: n, output: d, match: s, isMatch: r };
                  return (
            ...
            (l.test = (e, t, n, { glob: o, posix: r } = {}) => {
              ...
              return (
                !1 === p && ((u = i ? i(e) : e), (p = u === o)),
                (!1 !== p && !0 !== a.capture) ||
                  (p = !0 === a.matchBase || !0 === a.basename ? l.matchBase(e, t, n, r) : t.exec(u)),
              ...
              (l.makeRe = (e, t, n = !1, o = !1) => {
                ...
                let s,
                  ...
                  p = '';
                return (
                  e.startsWith('./') && ((e = e.slice(2)), (p = i.prefix = './')),
                  !1 === r.fastpaths || ('.' !== e[0] && '*' !== e[0]) || (s = a.fastpaths(e, t)),
                  void 0 === s ? ((i = a(e, t)), (i.prefix = p + (i.prefix || ''))) : (i.output = s),
                  l.compileRe(i, t, n, o)
                );
              }),
              (l.toRegex = (e, t) => {
            ...
            e.exports = (e, t) => {
              ...
              for (; T < E; ) {
                ...
                if (((w = F()), w !== s)) {
                  ...
                  if (w !== u) {
                    if (!0 !== n.noext) {
                      if (!0 === (w === h || w === a || w === r || w === g || w === p) && H.charCodeAt(T + 1) === d) {
          ...
          615: (e, t, n) => {
            ...
            const o = n(761),
              r = (e, t, n) => {
                ...
                let c = h(e) || h(t),
                  ...
                  f = [],
                  g = [];
                if ((c && ((d.isPadded = c), (d.maxLen = String(d.max).length)), p < 0)) {
                  (g = s(u < 0 ? Math.abs(u) : 1, Math.abs(p), d, a)), (p = d.a = 0);
                }
                return (
                  u >= 0 && (f = s(p, u, d, a)),
                  (d.negatives = g),
            ...
            function i(e, t, n, o, r) {
              ...
              for (let r of e) {
                let { string: e } = r;
                o || p(t, 'string', e) || a.push(n + e), o && p(t, 'string', e) && a.push(n + e);
              }
              return a;
            }
            function l(e, t) {
